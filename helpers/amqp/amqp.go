...
const (
	MailExchange = "profira.mail.exchange"
	//mail incoming
	MailIncoming = "profira.mail.incoming.queue"
	//mail deadletter
	MailDeadLetter = "profira.mail.deadletter.queue"

	//sms exchange
	SMSExchange = "profira.sms.exchange"
	//sms incoming
	SMSIncoming = "profira.sms.incoming.queue"
	//sms dead letter
	SMSDeadLetter = "profira.sms.deadletter.queue"

	// SendNotificationExchange ...
	SendNotificationExchange = "profira.send_notification.exchange"
	// SendNotification ...
	SendNotification = "profira.send_notification.incoming.queue"
	// SendNotificationDeadLetter ...
	SendNotificationDeadLetter = "profira.send_notification.deadletter.queue"
)
